...
public class SteerToCrosshairs extends CommandBase {
  ...
  public SteerToCrosshairs() {
    System.out.println("################################# SteerToCrosshairs()");
  ...
  public void initialize() {
    System.out.println("################################# SteerToCrosshairs.initialize()");
  }

  @Override
  public void execute() {
    //System.out.println("################################# SteerToCrosshairs.execute()");

    double azimuth = robot_.crosshairs_.getAzimuth(); // angle from robot to target
    //System.out.println("################################# SteerToCrosshairs.execute() + " + Math.round(azimuth*10.)/10. + " " + Math.round(robot_.crosshairs_.getRange()*10.)/10.);
    double velocity = robot_.chassis_.getVelocityCalculated()[2]; // current rotation speed

    //System.out.println("################################# SteerToCrosshairs.execute()" + azimuth + " " + velocity);
  ...
  public void end(boolean interrupted) {
    System.out.println("################################# SteerToCrosshairs.end(" + interrupted + ")");
    robot_.chassis_.setRotation(0);
  }
