...
public final class Constants {
    ...
    //public final double CAMERA_TILT = 23.; // degrees upward tilt
    //public final double CAMERA_HEIGHT = 17.; // inches from floor to camera lens
    //public final double CAMERA_POSITION_NORTH = 16.; // inches forward from chassis center to camera lens

    //public final double DOUBLE_CAMERA_TILT = 33.; // degrees upward tilt
    //public final double DOUBLE_CAMERA_HEIGHT = 12.; // inches from floor to camera lens
    //public final double DOUBLE_CAMERA_POSITION_NORTH = 15.; // inches forward from chassis center to camara lens
    //public final int DOUBLE_CAMERA_PIXEL_HEIGHT = 1000;
    //public final int DOUBLE_CAMERA_PIXEL_WIDTH = 760;
    //public final int DOUBLE_CAMERA_FOCAL_LENGTH = 523;
