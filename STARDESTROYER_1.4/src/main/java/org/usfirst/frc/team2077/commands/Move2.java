...
public class Move2 extends CommandBase {
  ...
  public void initialize() {
    ...
    acceleration_ = (new Acceleration(robot_.constants_.STARDESTROYER_ACCELERATION_G_LIMIT, robot_.constants_.STARDESTROYER_DECELERATION_G_LIMIT, robot_.chassis_, scale).get()); // TODO: Put acceleration/deceleration limits in constants
