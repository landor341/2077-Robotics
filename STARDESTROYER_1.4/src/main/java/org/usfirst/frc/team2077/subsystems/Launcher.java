...
import edu.wpi.first.networktables.NetworkTableEntry;//NEW
import edu.wpi.first.networktables.NetworkTableInstance;//NEW
...
public class Launcher extends SubsystemBase implements LauncherIF {
    ...
    // public void AJNew(){
// if(false){// ADD controls to SmartDashboard
//     SmartDashboard.putNumber("GetVoltage", 0);
//     SmartDashboard.putNumber("SetVoltage", 0);
//     SmartDashboard.putNumber("setLauncherRPM", 0);
//     SmartDashboard.putNumber("getLauncherRPM", 0);
// }

// double setMotorVoltage = SmartDashboard.getNumber("SetVoltage", 0);
// // if(setMotorVoltage > 0.5 || setMotorVoltage < -0.5){//Safety
// //     SmartDashboard.putNumber("SetVoltage", 0);
// //     setMotorVoltage = 0;
// // }
// launcherRunning_ = true;
// setLauncherRPM(SmartDashboard.getNumber("setLauncherRPM",300));
    ...
    private static double[] getAngleVelocity(double range) {
        ...
        //System.out.println("" + ravIndex[0] + " " + ravIndex[1] + " " + Math.round(interpolation*100.)/100.);
    ...
    private void runLauncher(double velocity) {
        ...
        double leftRPM = (velocity - bias) / unitsToRPM;
        double rightRPM = (velocity + bias) / unitsToRPM;
